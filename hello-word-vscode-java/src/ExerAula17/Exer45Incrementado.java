...
public class Exer45Incrementado {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        char gabarito1, gabarito2, gabarito3, gabarito4, gabarito5;
        char gabarito6, gabarito7, gabarito8, gabarito9, gabarito10;

        System.out.println("Professor, insira o gabarito da prova (A, B, C, D ou E):");
        System.out.print("Questão 01: ");
        gabarito1 = scanner.next().toUpperCase().charAt(0);
        System.out.print("Questão 02: ");
        gabarito2 = scanner.next().toUpperCase().charAt(0);
        System.out.print("Questão 03: ");
        gabarito3 = scanner.next().toUpperCase().charAt(0);
        System.out.print("Questão 04: ");
        gabarito4 = scanner.next().toUpperCase().charAt(0);
        System.out.print("Questão 05: ");
        gabarito5 = scanner.next().toUpperCase().charAt(0);
        System.out.print("Questão 06: ");
        gabarito6 = scanner.next().toUpperCase().charAt(0);
        System.out.print("Questão 07: ");
        gabarito7 = scanner.next().toUpperCase().charAt(0);
        System.out.print("Questão 08: ");
        gabarito8 = scanner.next().toUpperCase().charAt(0);
        System.out.print("Questão 09: ");
        gabarito9 = scanner.next().toUpperCase().charAt(0);
        System.out.print("Questão 10: ");
        gabarito10 = scanner.next().toUpperCase().charAt(0);
